defmodule WillsfishWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers WillsfishWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WillsfishWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WillsfishWeb.Gettext, "errors", msg, opts)
    end
  end
